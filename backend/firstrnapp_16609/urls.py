"""firstrnapp_16609 URL Configuration
...
admin.site.site_header = "FirstRNApp"
admin.site.site_title = "FirstRNApp Admin Portal"
admin.site.index_title = "FirstRNApp Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="FirstRNApp API",
        default_version="v1",
        description="API documentation for FirstRNApp App",
    ),
    public=True,
